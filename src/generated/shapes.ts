...
export const ELEMENT_SHAPES: Record<string, Record<string, string>> = {
  "Extension": {
  ...
  "ElementDefinition": {
    ...
    "type": "Element",
    "defaultValue[x]": "base64Binary",
    "meaningWhenMissing": "markdown",
    "orderMeaning": "string",
    "fixed[x]": "base64Binary",
    "pattern[x]": "base64Binary",
    "example": "Element",
    "minValue[x]": "date",
    "maxValue[x]": "date",
    "maxLength": "integer",
